...
class Markdown extends FilterBase {
  ...
  public function tips($long = FALSE) {
    if ($long) {
      ...
      return $this->t('You can use <a href="@filter_tips">Markdown syntax</a> to format and style the text. Also see <a href="@markdown_extra">Markdown Extra</a> for tables, footnotes, and more.', [
